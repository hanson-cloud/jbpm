...
public class DefaultCnToSpell {
	 ...
	 * @return
	 */
	public String cnToSpell(char cn) {
		try {
			int ascii = getCnAscii(cn);
			if (ascii < -20319 || ascii > -10247) { // �ǳ��ú���
	 ...
	 * @return
	 */
	public String cnToSingleSpell(String str){
		StringBuffer ret = new StringBuffer();
		for (int i = 0; i < str.length(); i++){
			ret.append(cnToSpell(str.charAt(i)).substring(0, 1));
		}
		return ret.toString();
	}
	 ...
	 * @return
	 */
	public String cnToSpellTail(String str){
		StringBuffer ret = new StringBuffer();
		for (int i = 0; i < str.length(); i++) {
			if (i == str.length() -1)
				ret.append(cnToSpell(str.charAt(i)));
	 ...
	 * @return
	 */
	public String cnToSpellHead(String str){
		StringBuffer ret = new StringBuffer();
		for (int i = 0; i < str.length(); i++) {
			if (i == 0)
				ret.append(cnToSpell(str.charAt(i)));
	...
	public static void  main(String[] args) {
		System.out.println(new DefaultCnToSpell().cnToSpellTail("�л�����"));
	}
}